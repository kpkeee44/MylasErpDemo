...
public class Attendance {
	...
	public String toString() {
		return "Attendance [id=" + id + ", empfname=" + empfname + ", emplname=" + emplname + ", leavestatus="
				+ leavestatus + ", month=" + month + ", year=" + year + ", updatedby=" + updatedby + ", createdby="
				+ createdby + ", createddate=" + createddate + ", updateddate=" + updateddate + ", day1=" + day1
				+ ", day2=" + day2 + ", day3=" + day3 + ", day4=" + day4 + ", day5=" + day5 + ", day6=" + day6
